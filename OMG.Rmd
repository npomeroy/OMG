...
<!--chapter:end:01-OCC-Research-Overview.Rmd-->

# (PART\*) Conducting a Research Cruise {-}
...
## Training
## Staffing (needs_buildout)
## Individual Staff Preparation (needs_buildout)
...
## Preparing the Ship (needs_buildout)
...
**Be sure and get network connectivity and server functionality working before sailing.**


<!--chapter:end:20-Planning-A-Field-Mission.Rmd-->
...
<!--chapter:end:23-Water-Sampling-and-CTD-Protocol.Rmd-->
...
<!--chapter:end:26-Coral-Coring.Rmd-->
...
<!--chapter:end:27-Tasks-At-Sea.Rmd-->
...
<!--chapter:end:28-Various-Underway-Resources.Rmd-->
...
<!--chapter:end:29-Post-Cruise-Activities.Rmd-->
...
<!--chapter:end:30-Instruments.Rmd-->
...
`r knitr::include_graphics(rep("images/DailyTasks7.jpg"))`
...
<!--chapter:end:35-Calcification-Accretion-Units-CAUs.Rmd-->
...
<!--chapter:end:40-Data-Management.Rmd-->
...
<!--chapter:end:45-Data-Processing.Rmd-->
...
<!--chapter:end:50-Inventory-and-Procurement.Rmd-->
...
<!--chapter:end:99-Blank_Example_Chapter.Rmd-->
