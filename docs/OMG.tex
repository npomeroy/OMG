...
\hypertarget{blank-filler-chapter}{%
\chapter{Blank Filler Chapter}\label{blank-filler-chapter}}
...
\subsection{RBR Solo V3 STR}\label{rbr-solo-v3-str}}
...
\hypertarget{sbe56}{%
\subsection{Seabird Electronics SBE56 STR}\label{sbe56}}

The SBE56 is programmed to sample every 5 minutes for 30S. The user manual for the SBE56 can be found \href{https://drive.google.com/drive/folders/1ujFmH1pJ704ikrsc11Ji2eNeuIBQ5JMa}{here}.
