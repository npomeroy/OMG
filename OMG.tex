...
\hypertarget{htmlwidget-fbd05478bd6cbd9ff9b0}{}
...
\hypertarget{calcification-accretion-unit-cau-schematic}{%
\subsection{Calcification Accretion Unit (CAU) schematic}\label{calcification-accretion-unit-cau-schematic}}
...
\hypertarget{id-tags}{%
\subsubsection{\texorpdfstring{\emph{ID Tags}}{ID Tags}}\label{id-tags}}
...
e.g.~PAL01\_2012\_5319\_U; PAL01\_2012\_5319\_L
...
\item
  ...
  An example of a plate photo ID: PAL01\_2012\_5319\_U\_T
\item
...
\hypertarget{re-sealable-bag-id}{%
\subsubsection{\texorpdfstring{\emph{Re-sealable Bag ID}}{Re-sealable Bag ID}}\label{re-sealable-bag-id}}
...
\def\labelenumi{\arabic{enumi}.}
\item
  Using the \textbf{ESD Apex CAU Mission App} (or the CAU Data Entry tool for ESD-CREP users, see Section VI p.~20), have the Data Management team enter the CAU Site IDs (e.g.~PAL01) and 4-digit CAU Serial \#s (e.g.~5319) for each unit to be processed
\item
...
\hypertarget{pre-heat-drying-oven}{%
\subsubsection{\texorpdfstring{\emph{Pre-heat Drying Oven}}{Pre-heat Drying Oven}}\label{pre-heat-drying-oven}}
...
\hypertarget{prepare-5-hcl-acid-solution-in-2-liter-bottles}{%
\subsubsection{\texorpdfstring{\emph{Prepare 5\% HCl acid solution in 2-liter bottles}}{Prepare 5\% HCl acid solution in 2-liter bottles}}\label{prepare-5-hcl-acid-solution-in-2-liter-bottles}}
...
\section{CAU Processing Steps}\label{cau-processing-steps}}
...
\hypertarget{a.-dissassembling-and-photo-documentation}{%
\subsection{A. Dissassembling and Photo-documentation}\label{a.-dissassembling-and-photo-documentation}}
...
\setcounter{enumi}{6}
\item
  It is recommended to tether the camera to a computer and save the photos directly to the computer's local drive (while using the camera's SD card as a backup drive). Designate a folder where the CAU photoset will be stored directly. (May 2019 - ESD General (T:) Drive at: T:\textbackslash Oceanography\textbackslash CAUs\textbackslash Analysis organized by Year and Cruise Mission, or Island Code for shore-based missions or those from the Atlantic.)
\item
...
\hypertarget{b.-determining-the-weight-of-the-cau-plate}{%
\subsection{B. Determining the weight of the CAU plate}\label{b.-determining-the-weight-of-the-cau-plate}}
...
\hypertarget{c.-decalcification-of-caco3-in-hydrochloric-acid}{%
\subsection{C. Decalcification of CaCO3 in Hydrochloric Acid}\label{c.-decalcification-of-caco3-in-hydrochloric-acid}}
...
\hypertarget{d.-vacuum-filtration-of-fleshy-material}{%
\subsection{D. Vacuum filtration of fleshy material}\label{d.-vacuum-filtration-of-fleshy-material}}
...
\hypertarget{e.-determining-the-weight-of-the-fleshy-material}{%
\subsection{E. Determining the weight of the fleshy material}\label{e.-determining-the-weight-of-the-fleshy-material}}
...
\section{Processing Timeline}\label{processing-timeline}}
...
\toprule
Sun & M & T & W & Th & F & Sat\tabularnewline
\midrule
\endhead
Prep & Prep & Def & Proc & AD & AD & Week 1 \textbf{PREP, DISASSEMBLE}\tabularnewline
AD & OD & W/O & W/O & w/Decal & W/Decal & Decal\tabularnewline
Decal & Sc/Decal & Sc/Decal & Filt & Filt & Filt & AD\tabularnewline
AD & W/O & W/O & w/O & w/O & W/O &\tabularnewline
\bottomrule
\end{longtable}
...
\textbf{Prep} \emph{Prep labels, dilute acid, etc.} 8x2
\textbf{Def} \emph{Defrost; prep lab} 2
\textbf{Proc} \emph{Process: Dismantle and photograph} 7
\textbf{AD} \emph{Air-dry}
\textbf{OD} \emph{Oven-dry}
\textbf{Decal} \emph{Decalcify (sit in 5\% HCl bath)} 4
\textbf{Sc/Decal} \emph{Scrape and decalcify} 7x2
\textbf{Filt} \emph{Vacuum filtration process} 7x3
\textbf{W/O} \emph{Weigh (and oven-dry)} 1x7
\textbf{W/Decal} \emph{Weigh and decalcify (pour HCl; pulverize large pieces)} 7x2
-----
\textbf{85}

\hypertarget{camera-tethering-and-cau-plate-photo-documentation-via-nikon-camera-control-pro-2}{%
\section{Camera tethering and CAU plate photo-documentation via Nikon Camera Control Pro 2}\label{camera-tethering-and-cau-plate-photo-documentation-via-nikon-camera-control-pro-2}}
...
\hypertarget{a.-installing-the-software}{%
\subsection{A. Installing the software}\label{a.-installing-the-software}}

For ESD-CREP users, the installation instructions and software product key can be accessed in the network folder \emph{T:\textbackslash general\textbackslash ProjectGroup\textbackslash Ocean Acidification\textbackslash CAUs\Analysis\textbackslash CAU Processing SOP, Data sheet, Labels\textbackslash CAU SOPs 2015\textbackslash CAUSOP\_NikonD7000Settings.pdf}

\hypertarget{b.-connecting-the-camera-to-the-computer}{%
\subsection{B. Connecting the camera to the computer}\label{b.-connecting-the-camera-to-the-computer}}
...
\item
  ...
  ISO Sensitivity: \textbf{ISO 400}\\
  White Balance: \textbf{Auto}\\
  Option: \textbf{Normal}
\end{enumerate}
...
\end{verbatim}
  ...
  JPEG Compression: \textbf{Optimal quality}\\
  Image size: \textbf{Large (4928x3264)}\\
  Record to: \textbf{PC}\\
  Card Record Mode: \textbf{Backup}
\end{enumerate}
...
\hypertarget{c.-cau-plate-photo-documentation}{%
\subsection{C. CAU plate photo-documentation}\label{c.-cau-plate-photo-documentation}}
...
\tightlist
\item
  Click the \textbf{Browse} button next to the ``\emph{Destination folder}''. For ESD-CREP users, navigate to the appropriate CAU site and unit folder location ex: Documents\textbackslash CAU Analysis\textbackslash ASRAMP 2015\textbackslash PHOTO ANALYSIS\textbackslash SAMOA\textbackslash SWAINS\textbackslash SWA03\textbackslash SWA03\_368"` where the images will be downloaded as they are taken. Click \textbf{OK}
\end{enumerate}
...
\item
  On the Camera Control Pro main window, go to the Tools menu to display the \textbf{Transfer Options window}. Click on the \textbf{Browse} button next to the ``\emph{Destination folder}'' and \textbf{navigate to the next CAU site and unit folder} (e.g.~SWA03\_394). Repeat steps C. 7-13
\end{enumerate}
...
\item
  Backup the images by copying the \textbf{Island} parent folder, ex: Documents\textbackslash CAU Analysis\textbackslash ASRAMP 2015\textbackslash PHOTO ANALYSIS\textbackslash SAMOA\textbackslash SWAINS``` to the network drive, ex: T://Oceanography//CAUs//Analysis//2018\_CAU Analysis//ASRAMP18//PHOTO ANALYSIS//SAMOA//SWAINS and to the external hard drive. If prompted, select ``Overwrite''
\item
...
\item
  ...
  *SiteID\_RecoveryYear\_4-digitSerial\#\_PlateLocation (``U'' - upper plate, ``L'' - lower plate)\_PlateSurface (``T'' - top plate, ``B'' - bottom plate).jpg*
  ...
  Example:\\
  SWA03\_2015\_368\_U\_T\_ID.jpg -- Upper Plate, Top Side with tag\\
  SWA03\_2015\_368\_U\_T.jpg -- Upper Plate, Top Side\\
  SWA03\_2015\_368\_U\_B\_ID.jpg -- Upper Plate, Bottom Side with tag\\
  SWA03\_2015\_368\_U\_B.jpg -- Upper Plate, Bottom Side\\
  SWA03\_2015\_368\_L\_T\_ID.jpg -- Lower Plate, Top Side with tag\\
  SWA03\_2015\_368\_L\_T.jpg -- Lower Plate, Top Side\\
  SWA03\_2015\_368\_L\_B\_ID.jpg -- Lower Plate, Bottom Side with tag\\
  SWA03\_2015\_368\_L\_B.jpg -- Lower Plate, Bottom Side
\end{enumerate}
...
\tightlist
\item
  Copy the newly-renamed images to the network folder by copying the \textbf{Island} parent folder (e.g.~Documents//CAU Analysis//ASRAMP 2015//PHOTO ANALYSIS//SAMOA//SWAINS) to the network drive (e.g.~T://Oceanography//CAUs//Analysis//2018\_CAU Analysis//ASRAMP18//PHOTO ANALYSIS/SAMOA/SWAINS) and to the external hard drive. If prompted, select ``Overwrite''
\end{enumerate}
