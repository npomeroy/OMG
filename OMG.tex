...
\hypertarget{htmlwidget-a987dff3b9b90037b1f3}{}
...
\chapter{Calcification Accretion Unit (CAU) Laboratory Sample Processing SOP}\label{calcification-accretion-unit-cau-laboratory-sample-processing-sop}}
...
\section{Calcification Accretion Unit (CAU) schematic}\label{calcification-accretion-unit-cau-schematic}}

\includegraphics{images/CAU_assembly.jpg}

\hypertarget{preparation-work}{%
\section{Preparation Work}\label{preparation-work}}

\hypertarget{id-tags}{%
\subsection{\texorpdfstring{\emph{ID Tags}}{ID Tags}}\label{id-tags}}
...
\subsection{\texorpdfstring{\emph{Re-sealable Bag ID}}{Re-sealable Bag ID}}\label{re-sealable-bag-id}}
...
\subsection{\texorpdfstring{\emph{Database}}{Database}}\label{database}}
...
\subsection{\texorpdfstring{\emph{Pre-heat Drying Oven}}{Pre-heat Drying Oven}}\label{pre-heat-drying-oven}}
...
\subsection{\texorpdfstring{\emph{Prepare 5\% HCl acid solution in 2-liter bottles}}{Prepare 5\% HCl acid solution in 2-liter bottles}}\label{prepare-5-hcl-acid-solution-in-2-liter-bottles}}
...
\chapter{CAU Processing Steps}\label{cau-processing-steps}}
...
\chapter{Processing Timeline}\label{processing-timeline}}
...
\chapter{Camera tethering and CAU plate photo-documentation via Nikon Camera Control Pro 2}\label{camera-tethering-and-cau-plate-photo-documentation-via-nikon-camera-control-pro-2}}
...
For ESD-CREP users, the installation instructions and software product key can be accessed in the network folder \emph{T:\general\ProjectGroup\Ocean Acidification\CAUs\Analysis\CAU Processing SOP, Data sheet, Labels/CAU SOPs 2015/ CAUSOP\_NikonD7000Settings.pdf}
...
\tightlist
\item
  Click the \textbf{Browse} button next to the ``\emph{Destination folder}''. For ESD-CREP users, navigate to the appropriate CAU site and unit folder location (e.g.~Documents\CAU Analysis\ASRAMP 2015\PHOTO ANALYSIS\SAMOA\SWAINS\SWA03\SWA03\_368) where the images will be downloaded as they are taken. Click \textbf{OK}
\end{enumerate}
...
\item
  Backup the images by copying the \textbf{Island} parent folder (e.g.~Documents\CAU Analysis\ASRAMP 2015\PHOTO ANALYSIS\SAMOA\SWAINS) to the network drive (e.g.~\emph{T:/Oceanography/CAUs/Analysis/2018\_CAU Analysis/ASRAMP18/PHOTO ANALYSIS/SAMOA/SWAINS}) and to the external hard drive. If prompted, select ``Overwrite''
\item
